 ...
 * be homogeneous and must implement Hadoop's WritableComparable interface.
 * </p>
 * 
 * @param <E>
...
public class ArrayListWritableComparable<E extends WritableComparable> extends
        ArrayList<E> implements
        WritableComparable<ArrayListWritableComparable<E>>
{
    ...
    public void readFields(DataInput in) throws IOException
    {
        ...
        try
        {
            ...
            {
                obj = (E) c.getDeclaredConstructor().newInstance();
                obj.readFields(in);
                this.add(obj);
            }
        }
     ...
     * sorted after, or is equal to <code>obj</code>. The sort order is defined
     * as follows:
     * </p>
     * 
     * <ul>
     * <li>Each element in the list is compared sequentially from first to last.
     * </li>
