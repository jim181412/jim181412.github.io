...
public interface MapKS<K>
{
     ...
     * the short values, which is exactly what this implementation is trying to
    ...
    /**
     * A map entry (key-value pair) for <tt>MapKS</tt>. The
     * <tt>MapKS.entrySet</tt> method returns a collection-view of the map,
     ...
     * These <tt>MapKS.Entry</tt> objects are valid <i>only</i> for the duration
