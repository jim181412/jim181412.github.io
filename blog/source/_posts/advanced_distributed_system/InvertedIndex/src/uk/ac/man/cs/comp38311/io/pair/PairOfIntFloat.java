...
public class PairOfIntFloat implements WritableComparable<PairOfIntFloat>
{
    ...
    /** Comparator optimized for <code>PairOfIntFloat</code>. */
    public static class Comparator extends WritableComparator
    {

        /**
         * Creates a new Comparator optimized for <code>PairOfIntFloat</code>.
         */
        public Comparator()
        {
    ...
    { // register this comparator
        WritableComparator.define(PairOfIntFloat.class, new Comparator());
    }
}