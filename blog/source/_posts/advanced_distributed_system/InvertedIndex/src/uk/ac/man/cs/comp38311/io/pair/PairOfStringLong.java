...
/**
 * WritableComparable representing a pair consisting of a String and a long. The
    ...
    public static class Comparator extends WritableComparator
    {
        ...
        public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2)
        {
            try
            {
                ...
                long thisRightValue = readLong(b1, s1 + firstVIntL1
                        + firstStrL1);
                long thatRightValue = readLong(b2, s2 + firstVIntL2
                        + firstStrL2);
