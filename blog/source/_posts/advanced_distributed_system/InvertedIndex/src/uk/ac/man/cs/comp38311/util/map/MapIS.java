...
public interface MapIS
{
    ...
    /**
     * A map entry (key-value pair) for <tt>MapIS</tt>. The
     * <tt>MapIS.entrySet</tt> method returns a collection-view of the map,
     ...
     * These <tt>MapIS.Entry</tt> objects are valid <i>only</i> for the duration
