...
/**
 * WritableComparable representing a pair consisting of a long and a String. The
...
public class PairOfLongString implements WritableComparable<PairOfLongString>
{
    ...
    public boolean equals(Object obj)
    {
        ...
        return rightElement.equals(pair.getRightElement())
                && leftElement == pair.getLeftElement();
    }
    ...
    public int compareTo(PairOfLongString pair)
    {
        ...
        if (leftElement == pl)
        {
            if (rightElement.equals(pr)) return 0;
    ...
    public static class Comparator extends WritableComparator
    {
        ...
        public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2)
        {
            ...
            if (thisLeftValue == thatLeftValue)
            {
                ...
                return compareBytes(b1, s1 + 8 + n1, l1 - n1 - 8, b2, s2 + n2
                        + 8, l2 - n2 - 8);
            }
