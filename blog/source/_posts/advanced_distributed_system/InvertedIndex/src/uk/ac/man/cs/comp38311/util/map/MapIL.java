...
public interface MapIL
{
     ...
     */
    Set<MapIL.Entry> entrySet();

    /**
     * A map entry (key-value pair) for <tt>MapIL</tt>. The
     * <tt>MapIL.entrySet</tt> method returns a collection-view of the map,
     ...
     * These <tt>MapIL.Entry</tt> objects are valid <i>only</i> for the duration
