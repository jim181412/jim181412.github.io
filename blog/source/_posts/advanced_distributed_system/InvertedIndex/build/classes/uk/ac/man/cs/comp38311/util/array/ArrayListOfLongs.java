...
package uk.ac.man.cs.comp38311.util.array;
 ...
 */
public class ArrayListOfLongs implements RandomAccess, Cloneable,
        Iterable<Long>
{
     ...
     */
    public ArrayListOfLongs merge(ArrayListOfLongs sortedLst)
    {
        ArrayListOfLongs result = new ArrayListOfLongs();
        int indA = 0, indB = 0;
     ...
     * @return a new ArrayListOfLongs from <code>start</code> to
     *         <code>end</code>
     */
    ...
    {
        ArrayListOfLongs other = (ArrayListOfLongs) obj;
        if (isEmpty())
        {
            if (other.isEmpty())
            {
