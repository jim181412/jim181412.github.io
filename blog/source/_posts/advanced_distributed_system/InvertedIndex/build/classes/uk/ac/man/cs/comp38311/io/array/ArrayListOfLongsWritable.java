...
package uk.ac.man.cs.comp38311.io.array;
...
import uk.ac.man.cs.comp38311.util.array.ArrayListOfLongs;

/**
 * Writable extension of the {@code ArrayListOfLongs} class. This class provides
 * an efficient data structure to store a list of longs for MapReduce jobs.
 * 
 * @author Jimmy Lin
 */
public class ArrayListOfLongsWritable extends ArrayListOfLongs implements
        WritableComparable<ArrayListOfLongsWritable>
{
    ...
    /**
     * Constructs a deep copy of the ArrayListOfLongsWritable object given as
     * parameter.
     * 
     * @param other
     *            object to be copied
     ...
     */
    public static ArrayListOfLongsWritable fromArrayListOfLongs(
            ArrayListOfLongs a)
    {
