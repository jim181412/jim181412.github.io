...
package uk.ac.man.cs.comp38311.io.pair;
...
/**
 * WritableComparable representing a pair consisting of a long and an int. The
...
public class PairOfLongInt implements WritableComparable<PairOfLongInt>
{
    ...
    /** Comparator optimized for <code>PairOfLongInt</code>. */
    public static class Comparator extends WritableComparator
    {

        /**
         * Creates a new Comparator optimized for <code>PairOfLongInt</code>.
         */
        public Comparator()
        {
    ...
    { // register this comparator
        WritableComparator.define(PairOfLongInt.class, new Comparator());
    }
}
